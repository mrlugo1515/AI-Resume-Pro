        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {features.map((feature, i) => {
              ...
              return (
                <div key={feature.title} className="text-center animate-fade-in-up" style={{ animationDelay: `${i * 0.15}s` }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {pricingPlans.map((plan, i) => (
              <Card
                key={plan.name}
                hover
                className={`relative animate-fade-in-up ${plan.highlighted ? 'ring-2 ring-primary-500 shadow-xl scale-105 md:scale-105' : ''}`}
              ...
              >
                ...
                <Link to={plan.highlighted ? '/signup' : '/signup'}>
                  <Button
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <Link to="/signup">
            <Button
              variant="accent"
              size="xl"
              className="text-base shadow-xl shadow-accent-500/25"
            >
              Get Started Free
              <ArrowRight className="w-5 h-5" />
            </Button>
